<div class="wrapper">
    <div class="sidebar">
        ...
        <li><a id="buses" class="owner-sidebar-li" href="<?= ROOT ?>/registernewbuses">Buses</a></li>
        ...
        <li><a id="fares" class="owner-sidebar-li" href="<?= ROOT ?>/">Bus Fares</a></li>
        <li><a id="contacts" class="owner-sidebar-li" href="<?= ROOT ?>/ownercontactowners">Contacts</a></li>
    </div>
</div>
