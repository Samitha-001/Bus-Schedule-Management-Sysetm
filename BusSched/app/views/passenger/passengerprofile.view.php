...
<div class="container">
    ...
    <div class="passenger-profile-card">
        ...
        <div id="point-balance-div" class="info-grid" style="padding-left:5px;">
            <h1>Points:</h1>
            <p><?= $passenger->points ?></p>
            <h1>Value:</h1>
            <p><?= $passenger->points ?> LKR</p>
            <h1>Exp. date:</h1>
            <p><?= $passenger->points_expiry ?></p>
            <span></span>
        ...
        <div id='gift-points-div'>
            ...
            <div id="gift-points-amount">
                <input type="number" name="amount" id="points" placeholder="Enter points"
                       max="<?php if ($passenger->points > 5):
