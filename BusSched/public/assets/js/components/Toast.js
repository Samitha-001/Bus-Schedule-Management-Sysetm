class Toast {
     ...
     * @param {string} iconClassName Font Awesome Icon Classname
     * @param {string} iconColor Font Awesome Icon Color
     * @param {string} title Title of message
     * @param {string} message Message Content
     * @param {boolean} closable Boolean if toast can be closed
     * @param {number|null} duration Length of time (in ms) before the toast is closed automatically
     */
    ...
    createToast() {
        ...
        toast.className = 'toast p-4 pr-5 d-flex align-items-center rounded-sm shadow-sm';
        ...
        if (this.title != null) {
            ...
            toastTitle.className = 'toast-title uppercase';
