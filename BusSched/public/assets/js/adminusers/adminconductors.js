document.addEventListener("DOMContentLoaded", function () {
    ...
    function editRow(e) {
      ...
      let licence_no = tds[6].textContent.trim();
      let assigned_bus = tds[7].textContent.trim();
      let date_of_birth = tds[8].textContent.trim();
      ...
      inputs[3].value = licence_no;
      inputs[4].value = assigned_bus;
      inputs[5].value = date_of_birth;
