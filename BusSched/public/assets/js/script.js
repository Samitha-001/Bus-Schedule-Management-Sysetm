    ...
    if (cards[i].classList.contains("selected")) {
      ...
      if (i > 0) {
        ...
        cardsContainer.scrollLeft =
          ...
          (cardsContainer.offsetWidth - cards[i - 1].offsetWidth) / 2;
      } else {
        cards[cards.length - 1].classList.add("selected");
        cardsContainer.scrollLeft =
          cards[cards.length - 1].offsetLeft -
          cardsContainer.offsetLeft -
          (cardsContainer.offsetWidth - cards[cards.length - 1].offsetWidth) /
            2;
      }
      break;
    }
    ...
    if (cards[i].classList.contains("selected")) {
      ...
      if (i < cards.length - 1) {
        ...
        cardsContainer.scrollLeft =
          cards[0].offsetLeft -
          cardsContainer.offsetLeft -
          (cardsContainer.offsetWidth - cards[0].offsetWidth) / 2;
      }
      break;
    }
  }
